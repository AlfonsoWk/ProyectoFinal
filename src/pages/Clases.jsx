...
import "../css/Clases.css"; // Importamos el archivo CSS para aplicar estilos

const comment = '* Musculación: Todo el día';

const data = [
  { Hora: 8, Lunes: 'Funcional', Miercoles: 'Funcional', Viernes: 'Funcional', link: '/login' },
  { Hora: 9, Lunes: 'Localizada', Miercoles: 'Localizada', Viernes: 'Localizada', link: '/login' },
  { Hora: 10, Martes: 'Yoga', Jueves:  'Yoga', link: '/login' },
  { Hora: 11, Martes: 'Zumba', Jueves: 'Zumba', link: '/login' },
  { Hora: 12, Lunes: 'Elongacion', Miercoles: 'Elongacion',  Viernes: 'Elongacion', link: '/login' },
  { Hora: 13, Lunes: 'Funcional', Miercoles: 'Funcional', Viernes: 'Funcional', link: '/login' },
  { Hora: 14, Lunes: 'Localizada', Miercoles: 'Localizada', Viernes: 'Localizada', link: '/login' },
  { Hora: 15, Martes: 'Yoga', Jueves: 'Yoga', link: '/login' },
  { Hora: 16, Lunes: 'Zumba', Martes: 'Zumba', Miercoles: 'Zumba', Jueves: 'Zumba', Viernes: 'Zumba', link: '/login' },
  { Hora: 17, Martes: 'Elongacion', Jueves: 'Elongacion',  link: '/login' },
  { Hora: 18, Lunes: 'Aero Local',  Miercoles: 'Aero Local', Viernes: 'Aero Local', link: '/login' },
        ...
        <tbody>
          {data.map((item, index) => (
            <tr key={index}>
              ...
              <td>
                <a href={item.link} target="_blank" rel="noopener noreferrer" style={{fontWeight: 'bold'}}>
                  Reservar
                </a>
              </td>
            </tr>
